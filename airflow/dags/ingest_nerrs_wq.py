"""
Ingest NERRS wq data.
Instrumented records (continuous, from several locations at each NERR)

```mermaid
"NERRS CDMO" 
  -- "airflow ingest_nerr_wq" --> influxDB 
"""
import os
...
with DAG(
    ...
    PRODUCTS = ['ATemp','RH','BP','WSpd','Wdir','TotPAR','TotPrcp']
