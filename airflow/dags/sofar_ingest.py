...
with DAG(
    ...
    BashOperator(
        ...
        bash_command=(
            "curl 'https://api.sofarocean.com/fetch/download-sensor-data/?spotterId=SPOT-30987C&startDate={{ ds }}T{{ ts }}Z&endDate={{ ds - macros.timedelta(days=-1) }}T{{ ts }}Z&processingSources=all' "
            "  -X GET "
